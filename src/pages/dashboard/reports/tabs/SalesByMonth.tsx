...
import { isEven, monthNames } from "~utils/index"
...
const SalesByMonth: React.FC = () => {
  const { activeTradePoint } = useTradePoints()
  const { salesByMonth, getSalesByMonth } = useReports()
  const { head, details } = salesByMonth || {}
              ...
              .map((detail, index) => (
                ...
                >
                  <div className="col-span-2 self-end">
                    <p className="label-15 line-clamp-2">{monthNames[new Date(detail.month).getMonth()]}</p>
